...
class _PopupDisplayOptionsState extends State<PopupDisplayOptions> with WidgetsBindingObserver{
  ...
  Future<void> getWorkOrderList() async {
    ...
    String filterString = storedWorkStations.map<String>((ws) => "(WorkTypeId eq '${ws.workStationId}')").join(" or ");
    ...
    if (filterString.isNotEmpty) {
      ...
      var response = await serverCall.getWithParameters(
          UserData.accessToken, apiEndPoint, queryParameters,widget.refreshTokenFunction);
...
class RectanglePainter extends CustomPainter {
  ...
  RectanglePainter(this.rects, this.colors, this.maximumZoomReached, this.tickedStatuses,this.workOrders,this.context, this.storedWorkStations);
  ...
  void paint(Canvas canvas, Size size) {
    for (int i = 0; i < rects.length; i++) {
      ...
      if (maximumZoomReached) {
        ...
        String? workTypeId;
        workTypeId = storedWorkStations[i].workStationId;
        // if (i == 0) {
        //   workTypeId = storedWorkStations[i]['workStationId']; // Top-left
        // } else if (i == 1) {
...
class RectanglePainterPriority extends CustomPainter {
  ...
  RectanglePainterPriority(this.rects, this.colors, this.workTasks, this.maximumZoomReached, this.tickedStatuses,this.workOrders,this.context, this.storedWorkStations);
