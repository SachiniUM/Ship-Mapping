...
class ZoomPinchOverlayPage extends StatefulWidget {
  ZoomPinchOverlayPage({Key? key, this.title}) : super(key: key);

  final String? title;

  @override
  _ZoomPinchOverlayPageState createState() => _ZoomPinchOverlayPageState();
}

class _ZoomPinchOverlayPageState extends State<ZoomPinchOverlayPage> {
...
void main() {
  runApp(MaterialApp(home: ZoomPinchOverlayPage()));
}
...
// import 'package:zoom_pinch_overlay/zoom_pinch_overlay.dart';
//
// class ZoomPinchOverlay extends StatefulWidget {
//   ZoomPinchOverlay({Key? key, this.title}) : super(key: key);
//
//   final String? title;
//
//   @override
//   _ZoomPinchOverlayState createState() => _ZoomPinchOverlayState();
// }
//
// class _ZoomPinchOverlayState extends State<ZoomPinchOverlay> {
//   Widget listRow(int profile, int image, int likes, String name, String text) {
//     return Column(
//         crossAxisAlignment: CrossAxisAlignment.start,
//         children: <Widget>[
